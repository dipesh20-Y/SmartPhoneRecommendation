...
/**
 * Recommendation.java
 * Represents a scored smartphone recommendation.
 * Wraps PhoneData and stores individual component scores.
 * This class was missing in the original upload.
 */
public class Recommendation {
    ...
    public PhoneData getPhone() { return phone; }
    ...
    public double getRamScore() { return ramScore; }
    public void setRamScore(double ramScore) { this.ramScore = ramScore; }

    public double getStorageScore() { return storageScore; }
    public void setStorageScore(double storageScore) { this.storageScore = storageScore; }

    public double getCameraScore() { return cameraScore; }
    public void setCameraScore(double cameraScore) { this.cameraScore = cameraScore; }
    ...
    public String toString() {
        return String.format("Recommendation[%s | Score: %.1f%%]", phone.getName(), overallScore);
    }
}